            ...
            <div class="col-md-12">
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn btn-dark font-weight-bold" href="?z=pegawai">PEGAWAI</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link btn btn-dark font-weight-bold" href="?z=admin">ADMIN</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link btn btn-dark font-weight-bold" href="?z=keluar">KELUAR</a>
                        </li>
                        </ul>
                    </div>
                </nav>
